...
public class FirstFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button b = (Button) view.findViewById(R.id.redButton);
        b.setOnClickListener(this);
        b = (Button) view.findViewById(R.id.greenButton);
        b.setOnClickListener(this);
        b = (Button) view.findViewById(R.id.blueButton);
        b.setOnClickListener(this);
        b = (Button) view.findViewById(R.id.goldButton);
        b.setOnClickListener(this);
        b = (Button) view.findViewById(R.id.purpleButton);
        b.setOnClickListener(this);
        return view;
    }
